...
public class TemperatureAwareParticle extends TemperatureDisplayingParticle {
    ...
    public TemperatureAwareParticle(ServerWorld world, Vec3d position, Vec3d velocity, float drag, Vec3d gravity, float temperature, float cooling, Vec3d buoyancy, float buoyancyTempMultiplier, int multiRuns, float variance) {

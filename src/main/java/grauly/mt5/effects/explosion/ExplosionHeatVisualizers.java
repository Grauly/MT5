...
public class ExplosionHeatVisualizers {
    ...
    static {
        ...
        //fieryFancyVisuals.add(0, new ParticleVisual(ParticleTypes.CAMPFIRE_COSY_SMOKE, 0, 0.5f, new Vec3d(0, 0.03, 0)));
        fieryFancyVisuals.setDefaultElement(new ParticleVisual(ParticleTypes.DRAGON_BREATH, 0, 0.5f, new Vec3d(0,0.03,0)));
    }

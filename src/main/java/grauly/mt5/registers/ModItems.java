...
public class ModItems {
    ...
    public static final Item TESTING_PISTOL = register(new AutomaticWeaponItem(new FabricItemSettings().rarity(Rarity.COMMON),ModPolymerModels.GLOCK,15,3,35,4*20,0,20,0.2f),"testing_pistol");
